...
// Lejárt kiemelt posztok eltávolítása
cleanupExpiredFeatured($connection);

// Kiemelt posztok ID-jának lekérése
$featured_post_ids = getFeaturedPosts($connection);

// Minden poszt lekérése az adatbázisból
$posts_query = "  SELECT 
            posts.id,
            posts.title,
            posts.body,
...
<section class="search__bar">
    <form action="<?= ROOT_URL ?>blog/search.php" class="container search__bar-container" method="GET">
        <div>
            <i class="uil uil-search"></i>
            <input type="search" name="search" placeholder="Keresés...">
        </div>
        <button class="btn" name="submit" type="submit">Keresés</button>
    </form>
</section>
<!-- KERESŐ VÉGE -->
